...
Expected owner: the Companion cluster, landed as (`dec:challenge:conjugate-model`); the current surface and its final arrangement are stated at (`dec:challenge:arrangement-final`).
