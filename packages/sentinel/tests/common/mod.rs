...
//! | Module          | Contents                                                    |
//! |-----------------|-------------------------------------------------------------|
//! | [`assertions`]  | [`assert_invariants()`], [`max_cusum()`], [`max_novelty_z()`], [`root_novelty_z()`] |
//! | [`builders`]    | [`seeded_sentinel()`], [`ScenarioBuilder`]                  |
//! | [`config`]      | [`test_config()`], [`cold_config()`], [`integration_config()`] |
//! | [`generators`]  | [`cell_values()`], [`anomalous_values()`]                   |
...
pub use assertions::{assert_invariants, max_cusum, max_novelty_z, root_novelty_z};
pub use builders::{ScenarioBuilder, seeded_sentinel};
pub use config::{cold_config, integration_config, test_config};
pub use generators::{anomalous_values, cell_values};
